...
void qratio(const char* fileLocation1, const char* fileLocation2, int nBins = 100, double lowRange = 0.8, double highRange = 1.0)
{
    ...
    double fitRangeMin1 = peakCenter1 - 3*peakWidth1;
    double fitRangeMax1 = peakCenter1 + 3*peakWidth1;
    ...
    // Define a narrower fit range around the peak
    double fitRangeMin2 = peakCenter2 - 3*peakWidth2;
    double fitRangeMax2 = peakCenter2 + 3*peakWidth2;
